...
public class ComingSoonFragment extends TabFragment {
    public static final String ACTION_DISPLAY = "io.github.marcinn.view.ComingSoonFragment:ACTION_DISPLAY";
    public static final String ACTION_SYNC = "io.github.marcinn.view.ComingSoonFragment:ACTION_SYNC";
