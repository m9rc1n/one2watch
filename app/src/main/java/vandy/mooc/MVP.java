...
public interface MVP {
     ...
     */
    public interface ProvidedPresenterOps extends PresenterOps<MVP.RequiredViewOps> {
        /**
     ...
     */
    public interface ProvidedModelOps extends ModelOps<MVP.RequiredPresenterOps> {
        /**
         * Initiate the asynchronous weather lookup when the user
         * presses the "Look Up Async" button.
         */
