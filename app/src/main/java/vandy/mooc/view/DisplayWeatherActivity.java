...
public class DisplayWeatherActivity extends LifecycleLoggingActivity {
     ...
     */
    public static final String ACTION_DISPLAY_WEATHER = "vandy.mooc.intent.action.DISPLAY_WEATHER";

    /**
     * MIME_TYPE of Weather Data
     */
    public static final String TYPE_WEATHER = "parcelable/weather";

    /**
     * Key for the List of Weather Data to be displayed
     */
    public static final String KEY_WEATHER_DATA = "weatherList";
    ...
    private void setViewFields(WeatherData weatherData) {
        ...
        final String dateText = WeatherUtils.formatCurrentDate();
        ...
        final String tempCelsius = WeatherUtils.formatTemperature(getApplicationContext(),
                temp,
                false) + "C";
        final String tempFarhenheit = WeatherUtils.formatTemperature(getApplicationContext(),
                temp,
                true) + "F";
